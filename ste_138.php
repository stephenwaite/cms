...
$handle_dat = fopen("aad2_garno_1.csv", "r");
...
foreach ($dan as $item) {
    ...
    $wsid_key = array_search($item[4], $garno);
    //echo $wsid_key;
    //exit;
    if ($wsid_key) {
        ...
        //echo $sid_ins[$wsid_key];
        switch ($sid_ins[$wsid_key]) {
            case 001:
                fwrite($handle_ste, $garno . ",Patient is payer\n");
                break;
            case 002:
