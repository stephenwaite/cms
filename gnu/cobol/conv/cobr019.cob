      ...
      * move the garbage to HEXNUM. Ignore DECNUM.
       ...
       P0.
           ...
           move file1301(62:3) to paycode.
           go to p1-1.
       P1.
           READ FILE13 AT END GO TO P99.
       p1-1.
           if file1301(62:3) not = paycode
            move file1301(62:3) to paycode
            move 0 to cntr
           end-if
           MOVE FILE1301(62:3) TO HEXNUM3
           ...
           MOVE FILE1301(1:11) TO HEXNUM11
           ...
           string hexval22 hexval8 delimited by size into fo-2
           move space to tab4501
           perform varying x from 1 by 3 until x > 44
           move "\" to tab45(x)
           end-perform
