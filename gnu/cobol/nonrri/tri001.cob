      ...
      *     DISPLAY "NOT A VT B/S ACCOUNT. TRY OUT-OF-STATE" BELL0
      *       END-IF
      *     END-IF.
      ...
      *     END-IF.
       ...
       2200-AMOUNT.
           ...
           IF G-COPAY > 99.99 DISPLAY "PROBABLY WRONG" BELL0.
           GO TO 4900DEE.
       2-PRNAME.
           IF IN-FIELD = "?"
