      ...
      *    02 L5F5 PIC ZZZ9.99CR.
       ...
       01  CHNL-X USAGE INDEX.
       01  CHNL-Y USAGE INDEX.
	   ...
	   ACCEPT BILL-DATE FROM DATE YYYYMMDD.
	   ...
	   ACCEPT TB-SHORT 
	   IF TB-SHORT = SPACE OR "3" OR "5" GO TO TB-LOW.
...
******* READ IN ALL   RECORDS TO TABLES FOR THIS GUARANTOR *******
	   ...
	   GO TO R6.
       R7. IF (TB-PAY NOT = SPACE) AND (TB-PAY NOT = "P" )
...
******* START WRITING OUTPUT *******
	   ...
	   ADD 1 TO LINE-CTR.
	   IF (LINE-CTR < 62) AND (G-DUNNING = "2") MOVE SPACE TO OUT01
	   ...
	   WRITE OUT01 FROM FOOT01 AFTER 2
...
******* WRITE THE DETAIL LINES ON BILL FOR CHARGES *******
       Q2. MOVE CHR-DATE-T(A) TO TEST-DATE.
           ...
           IF CHR-DIAG(A) = "0000000" MOVE "V7250  " TO L6F4.
...
******* SEARCH PAYMENT TABLE FOR PAYMENTS AGAINST THIS CLAIM *******
      ...
      *     WRITE CHNL-3 FROM CHNL-Y
           ...
           MOVE CHR-TOT(A) TO L6F7
           IF CHR-TOT(A) = 0 MOVE SPACE TO L6F7X ELSE MOVE L6F7 TO L6F7X.
