     ...
     *     BLOCK CONTAINS 6 RECORDS
      ...
      *     GO TO 1000-ACTION.
           ...
           IF DATAIN = "DR" PERFORM DR3 GO TO 1000-ACTION.
           ...
           CALL "trir011" USING ACTION ALF-8 
           GO TO 1000-ACTION.
           IF ACTION = "HS" OR "HSC" OR "HSP"
           MOVE PD-KEY8 TO ALF-8 CALL "trir011"
           ...
           CALL "trir205" USING PB1 G-GARNO
           MOVE 1 TO PB1
           OPEN I-O CHARCUR PAYFILE
           GO TO 1000-ACTION.
      ...
      *     GO TO 1000-ACTION.
       ...
       FP1.
           ...
           SET P-IND TO 1
           IF CD2 = 1 PERFORM CD-SET THRU CD-EXIT.
      ...
      *    SET P-IND DOWN BY 1
       ...
       FC3. READ CHARCUR NEXT AT END GO TO FC6.
           ...
           ELSE GO TO FC3.
           IF (CD2 = 0)
           OR ((CD2 = 1) AND (DATE-OF-CHARGE = CC-DATE-T OR SPACE))
           NEXT SENTENCE
           ELSE GO TO FC3.
      ...
      *     ADD 1 TO Z
       ...
       FC5. READ CHARFILE NEXT AT END GO TO FP1-EXIT.
           ...
           ELSE GO TO FC5.
           IF (CD2 = 0)
           OR ((CD2 = 1) AND (DATE-OF-CHARGE = CD-DATE-T OR SPACE))
           NEXT SENTENCE
           ELSE GO TO FC5.
           IF (IN-FIELD = "FT") OR (ACTION = "FT")
      ...
      *    DISPLAY PAYA-TAB(XX) " " A-TAB(P-IND)
       ...
       DR3. MULTIPLY DR2 BY -1 GIVING DR2.
           IF DR2 = 1
      ...
      *     MOVE TABDX(6) TO CC-DX6.
       ...
       LM-1.
           ...
           MOVE 0 TO X.
       LM-2.
           READ EMAILAUTHSSNFILE NEXT AT END GO TO LM-1-EXIT.
       ...
       9100-CLOSE-MASTER-FILE.
           ...
           CLOSE PAYFILE CHARCUR AUTHFILE FILEOUT GARFILE TAGDIAG

                EMAILAUTHSSNFILE CMNTFILE PATFILE CHARFILE PAYCUR.

           CLOSE PROCFILE DIAGFILE GAPFILE INSFILE MPLRFILE.

           CLOSE COMPFILE ADDRFILE REFPHY DOCPARM.
           STOP RUN.
