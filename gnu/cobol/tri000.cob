       ...
       A1. DISPLAY "ENTER A LINE OF COMMENT."
           ...
           MOVE CMNTFILE01 TO CMNT-BACK
           CLOSE CMNTFILE
           OPEN I-O CMNTFILE
           MOVE 0 TO XYZ.
       A2. 
           ADD 1 TO XYZ 
           MOVE XYZ TO CMNT-KEY3
           IF XYZ > 990
               DISPLAY "TOO MANY COMMENTS ALREADY"
               CLOSE CMNTFILE
               GO TO P0
           END-IF    
           
           READ CMNTFILE INVALID 
               GO TO A3
           END-READ
           GO TO A2.           
       A3.
       ...
       F2. READ CMNTFILE NEXT AT END GO TO P1.
        ...
        D2. MOVE GARNO TO CMNT-KEY8
            ...
            CLOSE CMNTFILE
            OPEN INPUT CMNTFILE
            READ CMNTFILE WITH LOCK INVALID 
                DISPLAY "RECORD NOT FOUND"
                GO TO D1
            END-READ    
            IF CMNT-STAT NOT = "00"
                DISPLAY "RECORD IS LOCKED"
                GO TO D1
            END-IF    
            DISPLAY CMNT-DATA
            DISPLAY "DELETE Y/N"
            ...
            DELETE CMNTFILE RECORD INVALID
                DISPLAY "UH OH, INVALID " CMNT-STAT
                CLOSE CMNTFILE
                GO TO P0
            END-DELETE    
