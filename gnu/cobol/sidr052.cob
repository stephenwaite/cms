       ...
       S1. 
           ...
           OR "7" OR "8" OR "9" MOVE PROC-KEY TO ALF1
           MOVE ALF1 TO NUM1
       ...
       L1. 
           ...
           DISPLAY PROC-KEY " " PROC-TYPE " " PROC-TITLE " " NEF-7.
       F1. 
           MOVE 0 TO X.
           MOVE SPACE TO ANS.
       ...
       F2. 
           ...
           DISPLAY X " " PROC-KEY " " PROC-TYPE " " PROC-TITLE " " 
           NEF-7.
           GO TO F2.
       A1. 
       ...
       T1. 
           ...
           ACCEPT PROC-TYPE.
           IF PROC-TYPE = "1" OR "5" GO TO A6
           ELSE DISPLAY "??? " PROC-TYPE.
       A6. 
           DISPLAY "FEE ?".
           ACCEPT ALF-7.
           IF ALF-7 = "?"
