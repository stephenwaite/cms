     ...
     *     BLOCK CONTAINS 6 RECORDS
      ...
      *    02 L6F1 PIC X(5).
       01  LINE-60.
           02 L60F1 PIC X(22) VALUE "    SIGNATURE ON FILE".
           02 FILLER PIC X(28) VALUE SPACE.
       ...
       01  AGE-DATE2.
           ...
           02 AGE2DD PIC 99.
       01  AGE-PAT PIC 999.
      *    this represents [&a3R[&a1L[&l2H 
       01  CHNL-1 PIC X(15) VALUE H"1B266133521B2661314C1B266C3248".
       01  CHNL-2 PIC X(6) VALUE H"1B2661353352".
       01  HEADER PIC X(85).
       PROCEDURE DIVISION.
       Q0.
      ...
      *     READ SORFILE AT END GO TO P10.
       ...
       P1-1.
           ...
           READ GARFILE INVALID DISPLAY "NO GARNO " CC-KEY8 GO TO P1.
           MOVE G-GARNO TO MPLR-KEY
           READ MPLRFILE INVALID MOVE SPACE TO MPLRFILE01.
           ...
           AND (PAT-RELATE NOT = INSRELATE) MOVE " X " TO L2F3.
       ...
       HERE-1.
           ...
           GO TO P3.
       P2. READ FILEIN AT END PERFORM A7 PERFORM A5 PERFORM A6
           GO TO P10.
      *     IF NOT (FI-PC = 004 OR 064) GO TO P2.
           ...
           GO TO P1-1.
           IF CNTR > 6 PERFORM A7 PERFORM A5 PERFORM A6 PERFORM A3
      ...
      *     PERFORM RA-1 
           ...
           MOVE SPACE TO F101(CNTR) F102(CNTR) F103(CNTR) L10F5(CNTR)
       ...
       NDC-EXIT.
           EXIT.
       A3.
      *     WRITE OUT01 FROM CHNL-1 BEFORE 1
      *     WRITE OUT01 FROM LINE-0      
      *     WRITE OUT01 FROM LINE-00 AFTER 3
           STRING CHNL-1 LINE-0 DELIMITED BY SIZE INTO HEADER.
           WRITE OUT01 FROM HEADER BEFORE 1
      *     WRITE OUT01 FROM LINE-0      
           WRITE OUT01 FROM LINE-00 AFTER 2
