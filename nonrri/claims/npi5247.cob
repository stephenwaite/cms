     ...
     *     BLOCK CONTAINS 6 RECORDS
      ...
      *    BLOCK CONTAINS 5 RECORDS
       ...
       01  FILETAB01.
           02 FILETAB PIC X(185) OCCURS 50 TIMES.
       01  tab11601.
       ...
       01  HOLD-FILEIN01.
           ...
           02 HOLD-PAPER PIC X.
           02 HOLD-PLACE PIC X.
           02 HOLD-NAME PIC X(24).
           02 HOLD-ESPDT PIC X.
           02 HOLD-DATE-T PIC X(8).
           02 HOLD-DATE-E PIC X(8).
           02 HOLD-ORDER PIC X(6).
           02 HOLD-DX2 PIC X(7).
           02 HOLD-DX3 PIC X(7).
      ...
      *     MOVE ":" TO CLM-COLON-ACCIDENT.
       ...
       2400SRV.
           ...
           AND  (CD-DIAG > "V25  " AND < "V2700"))
           OR ((CD-DATE-T > "20150930")
           AND (CD-DIAG > "Z2999  " AND < "Z3200  "))

           OR (CD-PROC > "58599ZZ" AND < "58620  ")
           OR (CD-PROC = "90699ZM" OR "99070ZM" OR "90040ZM")
           OR (CD-PROC = "58982  " OR "58983  " OR "58984  ")
           MOVE "Y" TO SV1-FAMILY.
           IF NOT (CD-PAYCODE = 004 OR 064)
           MOVE SPACE TO SV1-FAMILY.
           PERFORM SV-MOD
      ...
      *     PERFORM DIAG-3 VARYING A FROM 1 BY 1 UNTIL A > 12
       ...
       2400srv-1.
           ...
           PERFORM 2420A.
           MOVE FILEIN-KEY TO CHARFILE-KEY
           READ CHARFILE WITH LOCK INVALID GO TO 2400SRV-EXIT.
           IF CD-REC-STAT = "0" MOVE "2" TO CD-REC-STAT.
           IF CD-REC-STAT = "1" MOVE "3" TO CD-REC-STAT.
           MOVE BHT-DATE TO CD-DATE-A.
           REWRITE CHARFILE01.
       2400SRV-EXIT.  EXIT.
       2410.
      ...
      * INDIVIDUAL PROVIDER DATA
       ...
       DF-SEARCH2.  
           ...
           MOVE PL-NUM(Y) TO CD-PL
           MOVE Y TO PLACE-POINTER
           PERFORM PLACE-OF-SERVICE
           MOVE PLINDX TO Y.
       PLACE-OF-SERVICE.
           IF CD-PL = "1" MOVE "11" TO CLM-5.
           IF CD-PL = "3" MOVE "21" TO CLM-5.
           IF CD-PL = "4" MOVE "32" TO CLM-5.
           IF CD-PL = "5" MOVE "22" TO CLM-5.
           IF CD-PL = "6" MOVE "81" TO CLM-5.
           IF CD-PL = "7" MOVE "61" TO CLM-5.
           IF CD-PL = "8" MOVE "99" TO CLM-5.
           IF CD-PL = "E" MOVE "23" TO CLM-5. 
           IF CD-PL = "K" MOVE "31" TO CLM-5.
           IF CD-PL = "D" MOVE "33" TO CLM-5.
           IF CD-PL = "Q" MOVE "13" TO CLM-5.
           IF CD-PL = "S" MOVE "03" TO CLM-5.
           IF CD-PL = "T" MOVE "99" TO CLM-5.
           IF CD-PL = "Z" MOVE "02" TO CLM-5.
      ...
      *     WRITE SEGFILE01 FROM IEA01.
       ...
       P99. 
            ...
            CLOSE GARFILE HIPCLAIMFILE CHARFILE ERRFILE.
            STOP RUN.
