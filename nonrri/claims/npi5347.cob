     ...
     *     BLOCK CONTAINS 6 RECORDS
      ...
      *     IF G-PRINS NOT = "003" 
           GO TO CAS-TOT-1.
           MOVE 0 TO CAS-REDUCE(X) CAS-PAID(X) CLM-BAL(X)
       ...
       CAS-TOT-1.
           ...
           MOVE 0 TO CAS-REDUCEX CAS-REDUCE(X) CAS-PAID(X)
             CLM-BAL(X)
      ...
      *     WRITE SEGFILE01 FROM REF01.
           ...
           IF SBR-INSCODE = "MB" OR "  " MOVE "MDB" TO NM1-CODE. 
           MOVE SPACE TO SEGFILE01
           WRITE SEGFILE01 FROM NM101.
           MOVE SPACE TO N3-STREET N3-BILLADD
