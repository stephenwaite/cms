      ...
      *       DISPLAY "WE FOUND THE CHARGE BY SVC " G-GARNO
      *       ACCEPT OMITTED  
             GO TO P4-SVC-LOOP.
      *     ELSE 
      ...
      *     DISPLAY "CC-PROC1 " CC-PROC1 " CC-PROC2" CC-PROC2
      *       " CC-PROC1X " CC-PROC1X " CC-PROC2X " CC-PROC2X
      *     ACCEPT OMITTED    
      ...
      *       DISPLAY "BAD DATES? T " CC-DATE-T " DATE-CC " DATE-CC
      *       ACCEPT OMITTED  
             GO TO LOOK-1.                        
