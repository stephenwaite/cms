      ...
      *      DISPLAY "find-cntr " find-cntr " equals SVC-CNTR" SVC-CNTR
               GO TO P4-SVC-LOOP
           END-IF.    
      ...
      *       DISPLAY "FIND-CNTR " find-cntr " NOT EQUALS SVC-CNTR "
      *           SVC-CNTR            
      ...
      * RECORD ARE GOOD! START MAKING PAYMENT RECORDS.
       P4-SVC-LOOP.
           IF NOT (CLP-2CLMSTAT = "1" OR "2" OR "3" OR "19" OR "20"
               OR "21" OR "22" )
             PERFORM P1-DENIED-SVC THRU P1-LOST-SVC
             VARYING X FROM 1 BY 1 UNTIL X > SVC-CNTR
             GO TO P9-SVC-LOOP.
             ...
             IF CAS-SVC(Z) = X
              ...
              CAS-15 CAS-16 CAS-17 CAS-18 CAS-19 
               IF (CAS-2 = "1  " OR "126" OR "25 " OR "37 ") 
                ...
                MOVE CAS-CNTR TO Z
               END-IF
               IF CAS-2 = "24 "   OR CAS-5 = "24 " 
                OR CAS-8 = "24 "  OR CAS-11 = "24 " 
                OR CAS-14 = "24 " OR CAS-17 = "24 " 
                MOVE "MN" TO PD-MANAGE
               END-IF
               IF CAS-2 = "27 "   OR CAS-5 = "27 " 
                OR CAS-8 = "27 "  OR CAS-11 = "27 " 
                OR CAS-14 = "27 " OR CAS-17 = "27 " 
                MOVE "DA" TO PD-DENIAL
               END-IF

               IF CAS-1 = "PR"
                 MOVE CAS-3 TO PATRESP
               END-IF
             END-IF
            END-PERFORM.
           IF PD-AMOUNT NOT = 0
           ...
           WRITE PAYFILE01.
            ...
            PERFORM VARYING Z FROM 1 BY 1 UNTIL Z > CAS-CNTR
             IF CAS-SVC(Z) = X
              ...
              IF (CAS-1 = "CO") AND (CLP-2CLMSTAT = "1")
                ...
                END-IF
                IF (CAS-5 = "42 " OR "45 " OR "24 " OR "131")
                    AND (CAS-6 NOT = SPACE)
                  MOVE SPACE TO ALF8
                  MOVE CAS-6 TO ALF8
                  PERFORM AMOUNT-1
                ...
                END-IF
                 IF (CAS-8 = "42 " OR "45 " OR "24 " OR "131")
                  ...
                  COMPUTE INS-REDUCE = INS-REDUCE + AMOUNT-X
                END-IF
                IF (CAS-11 = "42 " OR "45 " OR "24 " OR "131")
                  ...
                  COMPUTE INS-REDUCE = INS-REDUCE + AMOUNT-X
                END-IF
                 IF (CAS-14 = "42 " OR "45 " OR "24 " OR "131")
                  ...
                  COMPUTE INS-REDUCE = INS-REDUCE + AMOUNT-X
                END-IF
                 IF (CAS-17 = "42 " OR "45 " OR "24 " OR "131")
            ...
            PERFORM VARYING Z FROM 1 BY 1 UNTIL Z > CAS-CNTR
             IF CAS-SVC(Z) = X
              ...
              CAS-8 CAS-9 CAS-10 CAS-11 CAS-12 CAS-13 CAS-14 
              CAS-15 CAS-16 CAS-17 CAS-18 CAS-19 
              IF (CAS-1 = "PR" AND CAS-2 = "96")
                 PERFORM P1-LOST-SVC
                 GO TO P5-SVC-LOOP-EXIT
              END-IF   
              IF (CAS-1 = "PR") AND (CLP-2CLMSTAT = "1")
      *          AND (FLAGZERO = 0)
                  MOVE SPACE TO ALF8
                  MOVE CAS-3 TO ALF8
                  PERFORM AMOUNT-1
                  ...
                  MOVE 1 TO FLAGCAS
              END-IF
              IF (CAS-4 = "PR") AND (CLP-2CLMSTAT = "1")
      *          AND (FLAGZERO = 0)
                  MOVE SPACE TO ALF8
                  MOVE CAS-3 TO ALF8
                  PERFORM AMOUNT-1
             ...
             END-IF
            END-PERFORM.
      *     IF AMOUNT-Y = 0 OR FLAGCAS = 0 GO TO P5-SVC-LOOP-EXIT.
           PERFORM COPAY-1 THRU COPAY-1-EXIT.
           COMPUTE INS-REDUCE = CC-AMOUNT + PD-AMOUNT - AMOUNT-Y
      *     IF INS-REDUCE < 0 GO TO P5-SVC-LOOP-EXIT.
      *     MOVE "14" TO PD-DENIAL
           MULTIPLY INS-REDUCE BY -1 GIVING PD-AMOUNT
      ...
      *     IF PD-PAYCODE NOT = G-PRINS GO TO WRITE-ADJ-EXIT.
       ...
       PC-1.
           ...
           START PAYCUR KEY NOT < PAYCUR-KEY INVALID GO TO PC-1-EXIT.
       ...
       COPAY-1.
           ...
           MOVE PD-KEY8 TO PC-KEY8
           MOVE SPACE TO PC-KEY3
           START PAYCUR KEY NOT < PAYCUR-KEY INVALID GO TO COPAY-1-EXIT.

       COPAY-2.
           READ PAYCUR NEXT AT END GO TO COPAY-1-EXIT.
           IF PC-KEY8 NOT = PD-KEY8 GO TO COPAY-1-EXIT.
           IF PC-CLAIM NOT = PD-CLAIM GO TO COPAY-2.
           IF (PC-PAYCODE = "001" OR "021" OR "022")
            AND (PC-DENIAL = "CP" OR SPACE)
            MOVE PC-AMOUNT TO CP-AMOUNT
            GO TO COPAY-1-EXIT.
           GO TO COPAY-2.
      ...
      *      GO TO LOOK-1.
      *    IF CC-AMOUNT NOT = CHARGE-X GO TO LOOK-1.
      
      *     DISPLAY "CC-PROC1 " CC-PROC1 " CC-PROC1X " CC-PROC1X
           
           IF CC-PROC1X = "G2012" AND FLAG-G2012 = "0"
               MOVE "99441" TO CC-PROC1X
           END-IF

           IF CC-PROC1X = "G2012" AND FLAG-G2012 = "1"
               MOVE "99442" TO CC-PROC1X
           END-IF
      ...
      *     DISPLAY "CC-PROC2 " CC-PROC2 " CC-PROC2X " CC-PROC2X
      ...
      *     PERFORM A5 THRU A5-EXIT
       ...
       P9. 
           ...
           STOP RUN.
       P999.
               IF (CAS-2 = "42 " OR "45 " OR "131" OR "B6 ")
               MOVE CAS-3 TO ALF8
               END-IF
               IF (CAS-5 = "42 " OR "45 "OR "131" OR "B6 ")
               MOVE CAS-5 TO ALF8
               END-IF
               IF (CAS-8 = "42 " OR "45 "OR "131" OR "B6 ")
               MOVE CAS-8 TO ALF8
               END-IF
               IF (CAS-11 = "42 " OR "45 "OR "131" OR "B6 ")
               MOVE CAS-11 TO ALF8
               END-IF
               IF (CAS-14 = "42 " OR "45 "OR "131" OR "B6 ")
               MOVE CAS-14 TO ALF8
               END-IF
               IF (CAS-17 = "42 " OR "45 "OR "131" OR "B6 ")
               MOVE CAS-17 TO ALF8
               END-IF.
