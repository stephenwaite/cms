      ...
      * @license https://github.com/openemr/openemr/blob/master/LICENSE GNU General Public License 3
       ...
       FILE-CONTROL.
           ...
           SELECT cascodefile ASSIGN TO "S65" ORGANIZATION IS INDEXED
           ACCESS IS DYNAMIC RECORD KEY IS cascode-key
           LOCK MODE MANUAL.
       ...
       01  HL01.
           ...
           02 HL-2 PIC X(27) VALUE "  RR MEDICARE UNPOSTED LIST   ".
      ...
      * VALIDATE INCOMING DATA AGAINST CHARGES
       P2-SVC-LOOP.
           ...
           IF G-PRINS NOT = "028" MOVE 2 TO GARFLAG.
      ...
      *        MOVE CAS-CNTR TO Z
       ...
       P1-LOST-SVC.
           ...
           IF CHR-AMT = PD-AMOUNTX
             MOVE 0 TO PD-AMOUNTX.
      ...
      *  START LOOKING FOR MATCHING CHARGES WITH THE GARNO IN QUESTION.
       ...
       LOOK-1. 
           ...
           IF CC-PAYCODE NOT = "028" GO TO LOOK-1.
       ...
       P9. 
           ...
           PERFORM VARYING Z FROM 1 BY 1 UNTIL NAR-KEY(Z) = SPACE
             MOVE NAR-KEY(Z) TO cascode-key
             READ cascodefile 
               INVALID 
                 MOVE SPACE TO CAID-REASON
             END-READ
             MOVE cascode-key TO EF2-DENIAL
