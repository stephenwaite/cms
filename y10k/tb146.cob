      ...
      * @license https://github.com/openemr/openemr/blob/master/LICENSE GNU General Public License 3
       ...
       P000.
           ...
           MOVE SPACE TO REF01
           UNSTRING FILEIN01 DELIMITED BY "*" INTO REF-0 REF-1 REF-2
           ...
           IF REF-1 = "1C" 
               MOVE REF-2 TO IN-LEG
           END-IF

           IF REF-1 = "TJ" 
               MOVE REF-2 TO IN-FEDID
           END-IF.    

       CHECK-ID.
           IF IN-NPI = PROV-1 OR PROV-2
               GO TO NEXT-PARA
           END-IF
      ...
      * VALIDATE INCOMING DATA AGAINST CHARGES
       P2-SVC-LOOP.
           DISPLAY "HAVE A CASH ADJUSTMENT  " SVC-CNTR
               ACCEPT OMITTED
      ...
      *     PERFORM P1-LOST-SVC GO TO P5-SVC-LOOP-EXIT.
       ...
       P4.
           ...
           PERFORM VARYING Z FROM 1 BY 1 UNTIL Z > CAS-CNTR
            ...
            END-IF
           END-PERFORM.
           DISPLAY "PAID AMOUNT IS " PD-AMOUNT " FOR " G-GARNO
      ...
      *     IF CC-PAYCODE NOT = "004" GO TO LOOK-1.
