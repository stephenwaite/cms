      ...
      *    DISPLAY "INVALID OPTION" GO TO 1000-ACTION.
       ...
       M1. PERFORM 1205-ADD-LOOP VARYING ADD-KEY FROM 1 BY 1
           ...
           ACCEPT DATE-E FROM CENTURY-DATE.
       ...
       1220-ADD-PROCESS.
           ...
           IF CD = 1 DISPLAY WINDOW ERASE PERFORM LR1.
      ...
      *        GO TO 1210-ADD-PROCESS
           ...
           IF (PAYCODE = "003" OR "028" OR "141") 
            ...
            AND (PROC1 = "11719" OR "11055" OR "11056" OR "11057" 
                OR "G0127")
            MOVE 1 TO FLAGX
            DISPLAY "ENTER DATE LAST SEEN FIELD 29" BELL
            DISPLAY "AND REFERRING PHYSICIAN IN FIELD 8" BELL
           END-IF.
           IF (PAYCODE = "003" OR "028" OR "141")
            AND (CD-DATE-M = "00000000") 
            ...
            PERFORM INPAT-1 THRU INPAT-1-EXIT VARYING X
             ...
             IF FLAG = 1
              DISPLAY "IN-PATIENT: HOSP ADMIT DATE  FIELD 29" BELL
              MOVE 1 TO FLAGX
             END-IF
           END-IF.
            IF (DOCR = "000") 
             ...
             DISPLAY "REF. PHYS. REQUIRED IN FIELD 8" BELL
             MOVE 1 TO FLAGX
             END-IF.
           IF FLAGX = 1
       ...
       M2. DISPLAY "MORE CHARGES ? " G-GARNAME.
           ...
           IF ANS = "Y" MOVE 
            "15180605242534223019200823091213282911273233"
            TO ADD-CON MOVE 22 TO MULT.              
           GO TO M1.
      ...
      *      2-DX5 2-DX6
       ...
       2400-FIND.
           ...
           DISPLAY " END OF FILE" BELL  GO TO 2000TI.
       ...
       2400-FIND-20.
           ...
           IF FLAG = 1 DISPLAY "END OF FILE FOUND" BELL
           ELSE DISPLAY "NO MORE MATCHES ON NAME" BELL.
           DISPLAY "END OF SEARCH"
           GO TO 1000-ACTION.
       2400-FIND-QUES.
           DISPLAY "?".
      ...
      *      GO TO 4900DEE.
       ...
       2160-DOCR.
           ...
           DISPLAY "REFERRING PHYS. REQUIRED ON THIS CHARGE." BELL.
       ...
       1REF-SEARCH.
           ...
           GO TO 3REF.
       1REF-KEY.
           START REFPHY KEY NOT < REF-KEY INVALID
           DISPLAY "END OF FILE" GO TO 2000TI.
           MOVE 0 TO X.
       ...
       2190-DAT1.
           ...
           GO TO 4900DEE.
           IF IN-FIELD-8 = "T" ACCEPT DAT1 FROM CENTURY-DATE 
           GO TO 4900DEE.
       ...
       4000-DATE-T.
           ...
           GO TO 2000TI.
           IF IN-FIELD-8 = "T" ACCEPT DATE-T FROM CENTURY-DATE
           GO TO 4900DEE.
           IF IN-FIELD-2 NUMERIC AND
           IN-FIELD-TAB(3) = " " AND IN-FIELD-TAB(4) = " "
           AND IN-FIELD-TAB(5) = " " AND IN-FIELD-TAB(6) = " "
      ...
      *    GO TO 4900DEE.
       ...
       2-DATE-A.
           ...
           GO TO 2000TI.
           IF IN-FIELD-8 = "T" ACCEPT CD-DATE-A FROM CENTURY-DATE
           GO TO 4900DEE.
           IF IN-FIELD-8 NUMERIC NEXT SENTENCE ELSE DISPLAY "INVALID"
           GO TO 2000TI.
           MOVE IN-FIELD-8 TO INPUT-DATE.
      ...
      *    CLOSE CHARFILE. OPEN I-O CHARFILE.
      ...
      -    " DATE VTCAID# REFPRMT".
       LI-1-EXIT. EXIT.
       CD-1. IF CD = 0 MOVE 1 TO CD DISPLAY "CHARGE LIST"
           ELSE MOVE 0 TO CD DISPLAY "NO CHARGE LIST AFTER ADD".

       DD-1. IF DD = 0 MOVE 1 TO DD DISPLAY "DEFAULT LIST"
           ELSE MOVE 0 TO DD DISPLAY "NO DEFAULT LIST AFTER ADD".
       PH-1. IF PH = 0 MOVE 1 TO PH DISPLAY "PHYS. NAME DISPLAY"
           ELSE MOVE 0 TO PH DISPLAY "NO PHYS. NAME DISPLAY".
      ...
      *     MOVE TABDX(6) TO CD-DX6.
       ...
       CD10.
           ...
           END-READ
           IF DIAG-TITLE(1:1) = "?" AND DATE-T > "20160930"
