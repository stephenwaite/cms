     ...
     *     BLOCK CONTAINS 6 RECORDS
      ...
      *    BLOCK CONTAINS 5 RECORDS
       ...
       01 GS01.
           ...
           02 GS-2 PIC X(6) VALUE "RR6355".
           02 GS-S2 PIC X VALUE "*".
           02 GS-3 PIC X(5) VALUE "00882".
       ...
       01  SUBM01.
           ...
           02 SUBM-NUM PIC X(9) VALUE "RR6355".
       ...
       01 RECNM101.
           ...
           02 RECNM1-NAMEL PIC X(12) VALUE "PALMETTO GBA".
           ...
           02 RECNM1-CODE PIC X(5) VALUE "00882".
      ...
      *      NM1-NAMEL NM1-NAMEF NM1-NAMEM NM1-NAMES
      *     WRITE SEGFILE01 FROM NM101
      ...
      *     END-IF.
       ...
       2010BB.
           ...
           MOVE "2" TO NM1-SOLO
           MOVE SPACE TO NM1-NAMEL NM1-NAMEF NM1-NAMEM NM1-NAMES
           MOVE "PALMETTO GBA" TO NM1-NAMEL
           MOVE "PI" TO NM1-EINSS
           MOVE "00882" TO NM1-CODE
           MOVE SPACE TO SEGFILE01
           WRITE SEGFILE01 FROM NM101.
           MOVE SPACE TO N3-STREET N3-BILLADD
           MOVE "PO BOX 10066" TO N3-STREET
           MOVE SPACE TO SEGFILE01
           WRITE SEGFILE01 FROM N301.
           MOVE SPACE TO N4-CITY N4-STATE N4-ZIP
           MOVE "AUGUSTA" TO N4-CITY
           MOVE "GA" TO N4-STATE
           MOVE "30999" TO N4-ZIP
           MOVE SPACE TO SEGFILE01
           WRITE SEGFILE01 FROM N401.
      ...
      *     MOVE ":" TO CLM-COLON-ACCIDENT.
       ...
       2310D.
           MOVE "77 " TO NM1-1
           MOVE "2" TO NM1-SOLO
           MOVE "RUTLAND HOSPITAL, INC." TO NM1-NAMEL
           MOVE SPACE TO NM1-NAMEF NM1-NAMEM NM1-NAMES
           MOVE "XX" TO NM1-EINSS
           MOVE "1720042203" TO NM1-CODE
           MOVE SPACE TO SEGFILE01
           WRITE SEGFILE01 FROM NM101
           MOVE SPACE TO N3-STREET N3-BILLADD
           MOVE "160 ALLEN STREET" TO N3-STREET
           MOVE SPACE TO SEGFILE01
           WRITE SEGFILE01 FROM N301
           MOVE SPACE TO N4-CITY N4-STATE N4-ZIP
           MOVE "RUTLAND" TO N4-CITY
           MOVE "VT" TO N4-STATE
           MOVE "057014560" TO N4-ZIP
           MOVE SPACE TO SEGFILE01
           WRITE SEGFILE01 FROM N401.
