      ...
      * 01  CNTR PIC 99 VALUE 0.
       ...
       0005-START.
           ...
           MOVE "NY MEDICAID ELECTRONIC CLAIMS ERRORS" TO ERRORFILE01
           WRITE ERRORFILE01
       ...
       P1. READ CHARCUR NEXT WITH LOCK AT END GO TO P0.
           ...
           AND 
           ((G-PRIPOL5 NOT NUMERIC) OR (G-PRIPOL2 NOT ALPHABETIC)
                                    OR (G-PRIPOL1 NOT ALPHABETIC))
           MOVE CHARCUR-KEY TO EF1 MOVE "BAD PRIMARY POLICY #" TO EF2
           PERFORM S1
           GO TO P1.

           IF (G-SEINS = CC-PAYCODE) 
           AND 
           ((G-SECPOL5 NOT NUMERIC) OR (G-SECPOL2 NOT ALPHABETIC)
                                    OR (G-SECPOL1 NOT ALPHABETIC))
           MOVE CHARCUR-KEY TO EF1 MOVE "BAD SECONDARY POLICY #" TO EF2
           PERFORM S1
           GO TO P1.
           IF (G-PRINS = CC-PAYCODE) 
           AND 
           ...
           PERFORM PAPER-1
           GO TO P1.
           IF CC-PAYCODE NOT = G-PRINS PERFORM PAPER-1 GO TO P1.
       ...
       TEST-IT.
           ...
           MOVE "NOT A MEDICAID CODED ACCOUNT" TO EF2
           PERFORM S1 
           GO TO P1.
