      ...
      * @license https://github.com/openemr/openemr/blob/master/LICENSE GNU General Public License 3
       ...
       PROCEDURE DIVISION.
       0005-START.
           OPEN INPUT INSFILE FILEIN GARFILE MPLRFILE PARMFILE
             PAYCUR CAIDFILE rarcfile AUTHFILE CHARCUR.
           OPEN I-O PAYFILE.
      ...
      *    IF F1 NOT = "CLP" GO TO P1-CLP.
       ...
       P1-CLP-1.
           ...
           IF NOT (PAYORID = "12115" AND CLP-2CLMSTAT  = "4")
             GO TO P00.
      ...
      *     ADD TOT-CLAIM TO TOT-TOT.
       ...
       P9. 
           ...
           CLOSE PAYFILE TRNPAYFILE GARFILE CHARCUR AUTHFILE 
           STOP RUN.
