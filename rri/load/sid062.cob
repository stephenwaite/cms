      ...
      *    DISPLAY "D = DELETE A PHYSICIAN CODE(BEWARE)"
           ...
           DISPLAY "NT = SEARCH FOR NPI AND TAXO IN DXC FILE"
      ...
      *      DISPLAY TEST-KEY " NOT INVALID"
       ...
       PROV-2.  
           ...
           IF ALF-4 = "1" 
             ...
             START PROVCAID KEY NOT < PROV-KEY
               INVALID
                 DISPLAY "END OF FILE" GO TO PROV-1.

           IF ALF-4 = "2" 
             MOVE ALF24 TO PROV-NAME
             START PROVCAID KEY NOT < PROV-NAME
               INVALID
                 DISPLAY "END OF FILE" GO TO PROV-1.

           IF ALF-4 = "3" 
             MOVE ALF24 TO PROV-NPI
             START PROVCAID KEY NOT < PROV-NPI
               INVALID
                 DISPLAY "END OF FILE" GO TO PROV-1.

           IF ALF-4 = "4" 
             MOVE ALF24 TO PROV-TAX
             START PROVCAID KEY NOT < PROV-TAX
               INVALID
                 DISPLAY "END OF FILE" GO TO PROV-1.
