      ...
      *
       ...
       F2. READ PAYMASTER NEXT AT END DISPLAY "END OF FILE"
           GO TO 1000-ACTION.
           ADD 1 TO X IF X < 10 
           PERFORM LG-1-0 GO TO F2.
           DISPLAY "?"
           MOVE 0 TO X 
           ACCEPT ANS 
           IF ANS = SPACE OR "D" GO TO F2.
           IF ANS NOT = "U"
           GO TO 1000-ACTION.
       F3. READ PAYMASTER PREVIOUS AT END DISPLAY "BEGINNING OF FILE"    
           GO TO 1000-ACTION.
           ADD 1 TO X IF X < 10 
           PERFORM LG-1-0 GO TO F3.
           DISPLAY "?"
           MOVE 0 TO X 
           ACCEPT ANS 
           IF ANS = SPACE OR "U" GO TO F3.
           IF ANS = "D" GO TO F2.
           GO TO 1000-ACTION.
